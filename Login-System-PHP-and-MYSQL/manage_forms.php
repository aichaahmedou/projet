...
<div class="container" id="form-field">
    <form id="form-data">
        <div class="row">
            <div class="card col-md-12 border border-secondary">
                <div class="card-body">
                    <h3 contenteditable="true" title="Enter Title" class="text-center" id="form-title">Entrer le titre</h3>
                    <hr class="border-primary">
                    <p contenteditable="true"  id="form-description" title="Enter Description" class="form-description text-center">Entrer une Description </p>
                </div>
                ...
                <div class="card mt-3 mb-3 col-md-12 question-item ui-state-default" data-item="0">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center d-flex">
                            <div class="col-sm-8">
                                <p class="question-text m-0" contenteditable="true" title="Write you question here">Entrer une question</p>
                            </div>
                            <div class="col-sm-4">
        ...
        <div class="d-flex w-100 justify-content-center" id="form-buidler-action">
            <button class="btn btn-default border mr-1" type="button" id="add_q-item"><i class="fa fa-plus"></i>Ajouter une question</button>
            <button class="btn btn-default border ml-1" type="button" id="save_form"><i class="fa fa-save"></i> Enregistrer</button>
        </div>
    </form>
</div>
...
<div class="card mt-3 mb-3 col-md-12 question-item ui-state-default" data-item="0">
    ...
    <div class="card-body">
        ...
        <div class="row ">
            <div class="form-group choice-field col-md-12">
                <textarea name="q[]" class="form-control col-sm-12" cols="30" rows="5" placeholder="repondre ici"></textarea>
            </div>
        </div>
    </div>
    <div class="card-footer">
